...
async function assertSticky(page, selector: string) {
...
test.describe("Welcome Card — mobile 375x812", () => {
  ...
  test("sticky image, independent scroll, text fade", async ({ page, baseURL }) => {
