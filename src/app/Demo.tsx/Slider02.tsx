...
import maritimeImg from "./Images/Admiralty01.jpg";
    ...
    () =>
      slides ?? [
        ...
        },
        {
          ...
          image:
            "https://images.unsplash.com/photo-1489515217757-5fd1be406fef?auto=format&fit=crop&w=2400&q=85",
        },
        {
          id: 3,
        ...
        },
        {
          ...
          image:
            "https://images.unsplash.com/photo-1542744173-05336fcc7ad4?auto=format&fit=crop&w=2400&q=85",
        },
      ],
    [slides]
  );
      ...
      <div className="relative z-10 h-full px-6 pt-10 md:px-12 md:pt-14 lg:px-24">
        ...
        <div className="absolute bottom-8 left-6 right-6 md:left-12 md:right-12 lg:left-24 lg:right-24">
          <div className={["flex items-center justify-between gap-6", isAr ? "flex-row-reverse" : ""].join(" ")}>
            ...
            <div className="flex-1 overflow-x-auto [scrollbar-width:none] [-ms-overflow-style:none] [&::-webkit-scrollbar]:hidden py-3">
                  ...
                  return (
                    ...
                    >
                      ...
                      <div
                        ...
                        style={{
                          background:
                            "linear-gradient(0deg, rgba(0,0,0,0.78) 0%, rgba(0,0,0,0.20) 60%, rgba(0,0,0,0.0) 100%)",
                        }}
                      />
