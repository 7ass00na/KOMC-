...
export default function AboutTeamGrid({ team, isRTL = false, startIndex = 0 }: { team: TeamMember[]; isRTL?: boolean; startIndex?: number }) {
  ...
  const credFor = (name: string) => {
    const map: Record<string, string> = {
      "Khaled Omer": isRTL ? "14 سنة" : "14y",
      "Mohamed Dafallah": isRTL ? "10 سنوات" : "10y",
      "Malik Omer": isRTL ? "8 سنوات" : "8y",
      "Ibrahim Hassan": isRTL ? "6 سنوات" : "6y",
      "خالد عمر": isRTL ? "14 سنة" : "14y",
      "محمد دفع الله": isRTL ? "10 سنوات" : "10y",
      "مالك عمر": isRTL ? "8 سنوات" : "8y",
      "ابراهيم حسن": isRTL ? "6 سنوات" : "6y",
    };
