  ...
  const items: Person[] =
    lang === "ar"
      ? [
          ...
          { name: "إبراهيم أبو رويس", role: "مدير العمليات", tags: ["أعمال", "إدارة"], slug: "nour-hassan", focus: "استشارات أعمال متنوعة", bio: "مستشار موثوق في استشارات الأعمال والإدارة.", regions: "UAE/EGP/SUD", experience: "15 سنة", rating: 89 },
        ]
      : [
